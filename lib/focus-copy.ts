...
export const streakCopy: Record<AppLanguage, {
  ...
  en: { streak: "Streak", best: "Best", badges: "Badges", days: "days", day: "day", toNext: "%d days to the next badge", allUnlocked: "All badges unlocked", startToday: "Start today", names: ["Quartz", "Jade", "Emerald", "Malachite", "Sapphire", "Amethyst", "Amber", "Diamond"] },
  es: { streak: "Racha", best: "Mejor", badges: "Insignias", days: "días", day: "día", toNext: "%d días para la próxima insignia", allUnlocked: "Todas las insignias desbloqueadas", startToday: "Empieza hoy", names: ["Cuarzo", "Jade", "Esmeralda", "Malaquita", "Zafiro", "Amatista", "Ámbar", "Diamante"] },
  pt: { streak: "Sequência", best: "Melhor", badges: "Emblemas", days: "dias", day: "dia", toNext: "%d dias para o próximo emblema", allUnlocked: "Todos os emblemas desbloqueados", startToday: "Comece hoje", names: ["Quartzo", "Jade", "Esmeralda", "Malaquita", "Safira", "Ametista", "Âmbar", "Diamante"] },
  fr: { streak: "Série", best: "Record", badges: "Badges", days: "jours", day: "jour", toNext: "%d jours avant le prochain badge", allUnlocked: "Tous les badges débloqués", startToday: "Commencez aujourd'hui", names: ["Quartz", "Jade", "Émeraude", "Malachite", "Saphir", "Améthyste", "Ambre", "Diamant"] },
  de: { streak: "Serie", best: "Bestwert", badges: "Abzeichen", days: "Tage", day: "Tag", toNext: "Noch %d Tage bis zum nächsten Abzeichen", allUnlocked: "Alle Abzeichen freigeschaltet", startToday: "Heute starten", names: ["Quarz", "Jade", "Smaragd", "Malachit", "Saphir", "Amethyst", "Bernstein", "Diamant"] },
  it: { streak: "Serie", best: "Record", badges: "Distintivi", days: "giorni", day: "giorno", toNext: "%d giorni al prossimo distintivo", allUnlocked: "Tutti i distintivi sbloccati", startToday: "Inizia oggi", names: ["Quarzo", "Giada", "Smeraldo", "Malachite", "Zaffiro", "Ametista", "Ambra", "Diamante"] },
  zh: { streak: "连续天数", best: "最佳", badges: "徽章", days: "天", day: "天", toNext: "距离下一个徽章还有 %d 天", allUnlocked: "已解锁全部徽章", startToday: "今天开始", names: ["石英", "翡翠", "祖母绿", "孔雀石", "蓝宝石", "紫水晶", "琥珀", "钻石"] },
  ja: { streak: "連続日数", best: "最高", badges: "バッジ", days: "日", day: "日", toNext: "次のバッジまであと%d日", allUnlocked: "すべてのバッジを獲得", startToday: "今日から始める", names: ["クォーツ", "ヒスイ", "エメラルド", "マラカイト", "サファイア", "アメジスト", "アンバー", "ダイヤモンド"] },
  ko: { streak: "연속", best: "최고", badges: "배지", days: "일", day: "일", toNext: "다음 배지까지 %d일", allUnlocked: "모든 배지 획득", startToday: "오늘 시작하기", names: ["수정", "비취", "에메랄드", "공작석", "사파이어", "자수정", "호박", "다이아몬드"] },
  ru: { streak: "Серия", best: "Рекорд", badges: "Значки", days: "дн.", day: "день", toNext: "До следующего значка %d дн.", allUnlocked: "Все значки открыты", startToday: "Начните сегодня", names: ["Кварц", "Нефрит", "Изумруд", "Малахит", "Сапфир", "Аметист", "Янтарь", "Алмаз"] },
  tr: { streak: "Seri", best: "Rekor", badges: "Rozetler", days: "gün", day: "gün", toNext: "Sonraki rozete %d gün", allUnlocked: "Tüm rozetler açıldı", startToday: "Bugün başla", names: ["Kuvars", "Yeşim", "Zümrüt", "Malakit", "Safir", "Ametist", "Kehribar", "Elmas"] },
  nl: { streak: "Reeks", best: "Record", badges: "Badges", days: "dagen", day: "dag", toNext: "Nog %d dagen tot de volgende badge", allUnlocked: "Alle badges vrijgespeeld", startToday: "Begin vandaag", names: ["Kwarts", "Jade", "Smaragd", "Malachiet", "Saffier", "Amethist", "Barnsteen", "Diamant"] },
  pl: { streak: "Seria", best: "Rekord", badges: "Odznaki", days: "dni", day: "dzień", toNext: "%d dni do kolejnej odznaki", allUnlocked: "Wszystkie odznaki zdobyte", startToday: "Zacznij dziś", names: ["Kwarc", "Jadeit", "Szmaragd", "Malachit", "Szafir", "Ametyst", "Bursztyn", "Diament"] }
};
